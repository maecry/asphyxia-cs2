...
{
	constexpr BarOverlayVar_t(const bool bEnable, const bool bGradient = false, const float flThickness = 1.f, const float flRounding = 0.f, const Color_t& colPrimary = Color_t(255, 255, 255), const Color_t& colSecondary = Color_t(255, 255, 255), const Color_t& colBackground = Color_t(0, 0, 0), const Color_t& colOutline = Color_t(0, 0, 0)) :
		bEnable(bEnable), bGradient(bGradient), flThickness(flThickness), flRounding(flRounding), colPrimary(colPrimary), colSecondary(colSecondary), colBackground(colBackground), colOutline(colOutline) { }
	...
	Color_t colBackground = Color_t(0, 0, 0);
	Color_t colOutline = Color_t(0, 0, 0);
};
